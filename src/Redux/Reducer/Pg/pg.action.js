...
export const getPg = () => async (dispatch) => {
    try {
        const pgList = axios({
            method: "GET",
            url: "https://sriher.herokuapp.com/pg/"
        }).then((response) => {
            return response;
        });        
...
export const getSpecificPG = (_id) => async (dispatch) => {
    try {
        const specificPgList = axios({
            method: "GET",
            url: `https://sriher.herokuapp.com/pg/get-pg/${_id}`
        }).then((response) => {
            return response;
        });
...
export const addPg = (pgData) => async (dispatch) => {
    try {
        const pg = axios({
            method: "POST",
            url: "https://sriher.herokuapp.com/pg/add-pg",
            data: {pgData},
        }).then((response) => {
            return response;
        });
...
export const updatePgData = (pgData) => async (dispatch) => {
    try {
        const pg = axios({
            method: "PUT",
            url: "https://sriher.herokuapp.com/pg/update-pg",
            data: {pgData},
        }).then((response) => {
            return response;
        });
...
export const deletePg = (_id) => async (dispatch) => {
    try {
        const deletePg = axios({
            method: "DELETE",
            url: `https://sriher.herokuapp.com/pg/delete-pg/${_id}`,
        }).then((response) => {
            return response;
        });
