...
export const getPhotos = () => async (dispatch) => {
    try {
        const photosList = axios({
            method: "GET",
            url: "https://sriher.herokuapp.com/photos/"
        }).then((response) => {
            return response;
        });
...
export const getSpecificPhotos = (_id) => async (dispatch) => {
    try {
        const specificPhoto = axios({
            method: "GET",
            url: `https://sriher.herokuapp.com/photos/get/${_id}`
        }).then((response) => {
            return response;
        });
...
export const addPhoto = (galleryData) => async (dispatch) => {
    try {
        const photo = axios({
            method: "POST",
            url: "https://sriher.herokuapp.com/photos/add-gallery",
            data: {galleryData},
        }).then((response) => {
            return response;
        });
...
export const updatePhotoData = (galleryData) => async (dispatch) => {
    try {
        const photo = axios({
            method: "PUT",
            url: "https://sriher.herokuapp.com/photos/update-gallery",
            data: {galleryData},
        }).then((response) => {
            return response;
        });
...
export const deletePhoto = (_id) => async (dispatch) => {
    try {
        const deletePhoto = axios({
            method: "DELETE",
            url: `https://sriher.herokuapp.com/photos/delete/${_id}`,
        }).then((response) => {
            return response;
        });
